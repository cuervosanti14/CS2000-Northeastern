# """
# Program to create a subplot of 2 rows and 2
# columns that contains all 4 plots from exercise 1
...
# Function 5: create subplot of 2 rows and 2 columns
#           that contains all 4 plots from exercise 1
def subplot():
    """
    Input: all 4 plots from exercise 1
    Behavior: return subplot of 2 rows and 2 columns that
              contains all 4 plots from exercise 1
    Output: subplot
    """
    # Subplot 1
    plt.subplot(2, 2, 1)
    ...
    # Show all subplots in 2 rows and 2 columns
    plt.show()
